...
# -*- coding: utf-8 -*-
"""
Created on Thu Nov 16 16:17:00 2023
...
if os.path.exists("saved_model/model_housing_32_6_1.keras"):
    model = tf.keras.models.load_model("saved_model/model_housing_32_6_1.keras")
    ...
    model.save('saved_model/model_housing_32_6_1.keras')
